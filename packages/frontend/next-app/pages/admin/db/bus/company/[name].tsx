...
export default function BusCompany() {
    ...
    const handleOnCreateBus = () => {
        modal.setModal(<CreateBus BusCompanyId={company?._id as string} />);
        modal.open();
    };
    ...
    return (
        <DbTemplate
            ...
            breadcrumbs={[
                ...
                { href: '/admin/db/bus', label: '버스 업체 관리' },
                { href: '/admin/db/bus/companies', label: '업체 목록' },
                {
                    href: '/admin/db/bus/company/' + name,
