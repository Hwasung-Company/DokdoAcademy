...
import { CreateBusCompanyInput } from 'nest-app/companies/dto/companies/bus/create/create-bus-company.dto';
...
function CreateBusCompany() {
    ...
    const error = useMemo(() => {
        return validate<CreateBusCompanyInput>(input, [
            'name',
            'address',
            'phone',
            'contact',
        ...
        >
            ...
            >
                ...
                <Typography variant={'caption'}>
                    Data Base Server에 버스 회사를 등록합니다. <br /> 등록한
                    업체는 세부 정보 페이지에서 수정할 수 있습니다.
                </Typography>
            </Box>
            <Box sx={{ padding: '1rem' }}>
                <Box
